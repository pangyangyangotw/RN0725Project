...
class HotelRuleScreen extends SuperView {
    ...
    _toContinuteOrder = () => {
        ...
        compSwitch?
        this.push('Hotel_comp_CreateOrderScreen', { model:this.params, item: this.paramItems, JourneyId:this.JourneyId})
        : 
        this.push('HotelOrder', { model:this.params, item: this.paramItems, JourneyId:this.JourneyId});
    }
    /**
     *   选择未预订低价酒店原因
     */
...
export default connect(getStatePorps)(HotelRuleScreen);
