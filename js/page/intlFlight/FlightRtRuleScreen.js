...
class FlightRtRuleScreen extends SuperView {
    ...
    _continueOrder = () => {
        ...
        if (canbinData) {
            ...
            var cabinReason = {
                CustomerReasonId: canbinData.selectReaon.Id,
                Reason: canbinData.selectReaon.Reason,
                ReasonEn: canbinData.selectReaon.ReasonEn,
                ReasonCode: canbinData.selectReaon.ReasonCode,
                RuleType: 3,
                OrderCategory: 1,
                NeedApproval: canbinData.NeedApproval,
                // CabinDiscountLimit: canbinData.Discount
            };
            ruleModelArr.push(cabinReason);
        }
        ...
        //     let a = lowPriceData.LowestFlight;
        // }            
        this._convertToOrder(this.params.journey,params.backRuleModel,params.backRuleModelArr);
     ...
     * 转换为订单model
     */
    _convertToOrder = (journey,backRuleModel,backRuleModelArr) => {
        
        const { queryModel,goRuleModel,goRuleModelArr } = this.params;
        ...
        this.order = {
            ...
            JourneyType: this.params.isRt ? 2 : 1,//1:单程，2:往返
            IsCustomTrip: this.params.isCustomerTab,
            AirList: [],
