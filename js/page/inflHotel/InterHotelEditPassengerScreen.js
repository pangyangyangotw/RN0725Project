...
export default class InterHotelEditPassengerScreen extends SuperView {
    constructor(props) {
        super(props);
        ...
        if(passenger&&passenger.CertificateId&&passenger.CertificateId==1){
            ...
            if(passenger.CertificateList && passenger.CertificateList.length>0){
                ...
                try {
                    ...
                    item = CertificateList.find(cert => cert.Type === 1); 
                } catch(e) {
                    console.error('Certificate parse error:', e);
                }
            }
        ...
        return (
            ...
            <KeyboardAwareScrollView keyboardShouldPersistTaps="handled" style={GlobalStyles.keyViewSy}  showsVerticalScrollIndicator={false}>
                ...
                <Bt_inputView dicKey={'英文姓'}
                                  required={true} 
                                  bt_text={
                                    // Util.RegEx.isEnName(passenger.LastName|| passenger.Surname)?'':passenger.LastName|| passenger.Surname
                ...
                <SelectView titleName={'国籍/地区'}
                                      required={false}
                                      _selectName={this.passenger.NationalCode&&this.passenger.NationalName ? this.passenger.NationalName : ''}
